...
import random
class PeriodicEnv3D(gym.Env):
    def __init__(self, cfg):
        super(PeriodicEnv3D, self).__init__()
        self.cfg = cfg
#         system parameters
...
#         print(action)
        ...
        kfactor = float(self.denormalize_actions(action)[2])
        gap =  round(float(self.denormalize_actions(action)[1]/ self.dt))
#         print(width_p, kfactor, gap)
